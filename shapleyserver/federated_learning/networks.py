...
class ModelHead(nn.Module):
    """ used to remove the final fc layer and construct a model head for feature extraction
    """
    def __init__(self, model):
        super(ModelHead, self).__init__()
        self.model_head = nn.Sequential(*list(model.children())[:-1])
...
''' Liner Model for tabular dataset'''
...
class MLP_tabular(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        self.fc_5 = nn.Linear(512, num_classes)
